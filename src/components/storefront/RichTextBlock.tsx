...
export default function RichTextBlock({ block }: RichTextBlockProps) {
    let spacingClass = 'py-12 px-6';
    if (block.spacing === 'none') spacingClass = 'py-4 px-6';
    if (block.spacing === 'small') spacingClass = 'py-8 px-6';
    if (block.spacing === 'large') spacingClass = 'py-20 px-6';
