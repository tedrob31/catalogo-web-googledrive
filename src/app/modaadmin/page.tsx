            ...
            <div className="grid gap-8 animate-in fade-in duration-300">
                <section className="bg-white p-6 rounded shadow">
                    ...
                    <div className="space-y-4">
                        <div>
                            <h3 className="text-lg font-semibold mb-2 mt-4 pb-2 border-b">Autenticación y Drive</h3>
                            
                            <div className="mb-4">
                                <label className="block text-sm font-medium">Correo de Administrador (Auth.r4tlabs.com)</label>
                                <input
                                    type="email"
                                    className="w-full border p-2 rounded"
                                    value={config.adminEmail || ''}
                                    placeholder="admin@r4tlabs.com"
                                    onChange={e => setConfig({ ...config, adminEmail: e.target.value })}
                                />
                                <p className="text-xs text-gray-500 mt-1">Este correo se usará para buscar tu token de Google Drive en Supabase.</p>
                            </div>
